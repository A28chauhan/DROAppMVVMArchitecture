package com.carematix.materialsearchview.widgets;
...
import com.carematix.materialsearchview.R;
import com.carematix.materialsearchview.interfaces.onSearchActionsListener;
import com.carematix.materialsearchview.interfaces.onSearchListener;
import com.carematix.materialsearchview.interfaces.onSimpleSearchActionsListener;
import com.carematix.materialsearchview.utils.Util;
...
public class MaterialSearchView extends FrameLayout implements View.OnClickListener, onSearchActionsListener {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_UP) &&
                    ...
                    if (!TextUtils.isEmpty(query) && mOnSearchListener != null) {
                        ...
                        mOnSearchListener.onSearchAction(query);
                    }
                    return true;
                }
                return false;
    ...
    private void clearSearch() {
        ...
        if (mOnSearchListener != null) {
            mOnSearchListener.onClearSearch();
        }
    }
